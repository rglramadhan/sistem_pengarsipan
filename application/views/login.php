...
<body class="bg-gradient-info">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                      <img width="30%" src="<?php echo base_url() ?>assets/img/logoxyz.png">
                                        <h5 class="text-gray-900 mb-4" style="margin-top: 10px">
                                            <b style="font-size: 14pt;">HALAMAN LOGIN<br>MANAGEMENT SISTEM INFORMASI PENGARSIPAN</b><br>
                                            <div style="font-size: 14pt">PT. XYZ</div>
                                            </h5>
                                    </div>
    ...
    <div class="container my-auto">
                <div class="copyright text-center my-auto" style="color: #fff; font-size: 8pt">
                    <span>Copyright &copy; <?php echo date('Y'); ?> PT. XYZ</span>
                </div>
            </div>
