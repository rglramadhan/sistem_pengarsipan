            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <div class="form-group">
                  <div class="col-lg-6">
                    <a href="<?php echo base_url('surat_keluar'); ?>" class="btn btn-social btn-flat btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Data Surat Keluar</a>
                  </div>
                </div>
                <br><br>
                <form class="form-horizontal" action="tambah_aksi_surat" method="post" enctype="multipart/form-data">
                   <div class="form-group">
                    <label class="control-label col-lg-2">Nama Surat Keluar</label>
                    <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <input type="datetime-local" name="tgl_keluar" class="form-control" value="" maxlength="100" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      ...
                      <small>Ukuran file max 10 mb</small>
                      <small class="text-red">Ekstensi pdf|docx|jpg|png</small>
